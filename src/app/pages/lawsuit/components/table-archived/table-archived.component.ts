...
@Component({
  ...
  templateUrl: './table-archived.component.html',
  styleUrls: ['./table-archived.component.scss'],
})
export class TableArchivedComponent implements OnInit, AfterViewInit {
